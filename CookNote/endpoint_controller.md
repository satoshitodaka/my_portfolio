...
|ユーザーアカウントを表示|GET|users/:id|users#show|
|ユーザーの新規作成画面を表示|GET|users/new|users#new|
|ユーザーを新規作成する|POST|users|users#create|
|ユーザーをフォローする|POST|relationships|relationships#create|
|ユーザーをフォローする|DELETE|relationships/:id|relationships#destroy|
|レシピの作成画面を表示|GET|recipes/new|recipes#new|
...
|材料の作成画面を表示|GET|recipes/:id/ingredients/new|ingredients#new|
|材料を作成する|POST|ingredients|ingredients#create|
...
|手順の作成画面を表示|GET|recipes/:id/directions/new|directions#new|
|手順を作成する|POST|directions|directions#create|
...
|コメントの作成画面を表示|GET|recipes/:recipe_id/comments/new|comments#new|
|コメントを作成する|POST|comments|comments#create|
...
|ストックの作成画面を表示|GET|stocks/new|stocks#new|
...
|ストックカテゴリーの作成画面を表示|GET|stock_categories/new|stock_categories#new|
...
|タグの作成画面を表示|GET|tags/new|tags#new|
...
|タグカテゴリーの作成画面を表示|GET|tag_categories/new|tag_categories#new|
